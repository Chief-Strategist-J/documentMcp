...
export interface Section {
  ...
  data?: any[]; // Real data for the section
  createdAt: Date;
}
...
export interface StylingSchema {
  ...
  row: RowStyle;
  cell: CellStyle;
  columnOverrides: { [key: string]: ColumnStyleOverride };
}
...
export interface UpdateSectionDataBulkRequest {
  data: any[];
}

export interface BulkCreateSectionsRequest {
  sections: Array<Omit<CreateSectionRequest, 'documentId'>>;
}
